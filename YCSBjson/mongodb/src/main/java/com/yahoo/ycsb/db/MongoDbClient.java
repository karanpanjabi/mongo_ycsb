...
public class MongoDbClient extends DB {
  ...
  public Status soeLoad(String table, Generator generator) {
    ...
    try {
      ...
      if (queryResult == null) {
        System.out.println("Empty return on load");
        return Status.OK;
      }

      SimpleDateFormat sdfr = new SimpleDateFormat("yyyy-MM-dd");
      // System.out.println(queryResult.get(Generator.SOE_FIELD_CUSTOMER_DOB));
      // String dobStr = queryResult.get(Generator.SOE_FIELD_CUSTOMER_DOB).toString();
      String dobStr = sdfr.format(queryResult.get(Generator.SOE_FIELD_CUSTOMER_DOB));
      // String dobStr = sdfr.format(sdfr.parse(queryResult.get(Generator.SOE_FIELD_CUSTOMER_DOB).toString()));
...
// *********************  SOE Read ********************************
  ...
  public Status soePage(String table, final Vector<HashMap<String, ByteIterator>> result, Generator gen) {
    ...
    try {
      ...
      // System.out.println("OI: "+projection.toJson());
      findIterable.projection(projection);
